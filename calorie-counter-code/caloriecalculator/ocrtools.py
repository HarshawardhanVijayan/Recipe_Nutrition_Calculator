...
def process_text_detection_to_file(document, out):
    ...
    client = boto3.client('textract',aws_access_key_id="AKIAWWZTL452R4PSJCD2",aws_secret_access_key="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",region_name="us-east-1")
    #open
