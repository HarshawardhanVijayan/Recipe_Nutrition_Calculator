...
class FoodDictionary:
    ...
    def calculateIngredient(self, query_string, quantity, unit):
        ...
        for resultInd in resultInds:
            ...
            score = cossims[resultInd]* float(self.foodjson[resultInd]['kcalpergram'])
            #print(score)
            if score > topScore:
                topIndex = resultInd
                topScore = score
        ...
        return unitgram * quantity * result['carbohydrateValue'],unitgram * quantity * result['proteinValue'],unitgram * quantity * result['fatValue']
